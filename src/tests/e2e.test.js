...
describe('E2E tests', function () {
    ...
    describe('Check Catalog Page with User [ 4 Points ]', async () => {
        ...
        it('Check Catalog Page with 2 albums [ 2 Points ]', async () => {
            ...
            const data = get(mockData.catalog.slice(0, 2));
            ...
            expect(titles[0]).to.contains(`Name: ${data[0].title}`);
            expect(titles[1]).to.contains(`Name: ${data[1].title}`);
        });
    });
    ...
    describe('Check Catalog Page with Guest [ 6 Points ]', async () => {
        ...
        it('Check Catalog Page with 2 albums [ 2 Points ]', async () => {
            ...
            expect(titles[0]).to.contains('Name_1');
            expect(titles[1]).to.contains('Name_2');
        });
